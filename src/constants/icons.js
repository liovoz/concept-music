...
export const ICONS = {
  ...
  'qq-music': {
    ...
    stroke: 'currentColor',
    strokeWidth: 2,
    content: '<path d="M 12 2.5 C 14.5 2.5 16.8 3.6 17.5 5.5 C 17.9 7.0 18.2 8.5 18.5 10.0 C 19.0 11.5 20.0 13.0 20.5 14.5 C 20.7 15.4 20.6 16.6 19.8 17.2 C 19.2 17.6 18.3 17.7 17.6 17.8 C 18.3 18.3 18.9 18.9 18.9 19.7 C 18.9 21.0 17.8 22.0 15.6 22.0 C 14.0 22.0 13.0 20.63 12 20.63 C 11.0 20.63 10.0 22.0 8.4 22.0 C 6.2 22.0 5.1 21.0 5.1 19.7 C 5.1 18.9 5.7 18.3 6.4 17.8 C 5.7 17.7 4.8 17.6 4.2 17.2 C 3.4 16.6 3.3 15.4 3.5 14.5 C 4.0 13.0 5.0 11.5 5.5 10.0 C 5.8 8.5 6.1 7.0 6.5 5.5 C 7.2 3.6 9.5 2.5 12 2.5 Z"/>'
  },
  'info': {
    viewBox: '0 0 24 24',
    fill: 'none',
  ...
  'fullscreen': {
    ...
    stroke: 'currentColor',
    strokeWidth: 2,
    content: '<path d="M8 3H5a2 2 0 0 0-2 2v3m18 0V5a2 2 0 0 0-2-2h-3m0 18h3a2 2 0 0 0 2-2v-3M3 16v3a2 2 0 0 0 2 2h3"/>'
  },
  'fullscreen-exit': {
    viewBox: '0 0 24 24',
    fill: 'none',
    stroke: 'currentColor',
    strokeWidth: 2,
    content: '<path d="M8 3v3a2 2 0 0 1-2 2H3m18 0h-3a2 2 0 0 1-2-2V3m0 18v-3a2 2 0 0 1 2-2h3M3 16h3a2 2 0 0 1 2 2v3"/>'
  },
  'font-size': {
    viewBox: '0 0 24 24',
    fill: 'none',
    stroke: 'currentColor',
    strokeWidth: 2,
    content: '<path d="M4 7V4h16v3M9 20h6M12 4v16"/>'
  },
  'translate': {
    viewBox: '0 0 24 24',
    fill: 'none',
    stroke: 'currentColor',
    strokeWidth: 2,
    content: '<path d="m5 8 6 6M4 14l6-6 2-3M2 5h12M7 2h1M22 22l-5-10-5 10M14 18h6"/>'
  },
  'sparkles': {
    viewBox: '0 0 24 24',
    fill: 'none',
  ...
  'disc': {
    ...
    stroke: 'currentColor',
    strokeWidth: 2,
    content: '<circle cx="12" cy="12" r="10"/><circle cx="12" cy="12" r="2"/>'
  },
  'image': {
    viewBox: '0 0 24 24',
    fill: 'none',
    stroke: 'currentColor',
    strokeWidth: 2,
    content: '<rect width="18" height="18" x="3" y="3" rx="2" ry="2"/><circle cx="9" cy="9" r="2"/><path d="m21 15-3.086-3.086a2 2 0 0 0-2.828 0L6 21"/>'
  },
  'film': {
    viewBox: '0 0 24 24',
    fill: 'none',
    stroke: 'currentColor',
    strokeWidth: 2,
    content: '<rect width="20" height="20" x="2" y="2" rx="2.18" ry="2.18"/><line x1="7" x2="7" y1="2" y2="22"/><line x1="17" x2="17" y1="2" y2="22"/><line x1="2" x2="22" y1="12" y2="12"/><line x1="2" x2="7" y1="7" y2="7"/><line x1="2" x2="7" y1="17" y2="17"/><line x1="17" x2="22" y1="17" y2="17"/><line x1="17" x2="22" y1="7" y2="7"/>'
  },
  'minimize': {
    viewBox: '0 0 24 24',
    fill: 'none',
  ...
  'phone': {
    ...
    stroke: 'currentColor',
    strokeWidth: 2,
    content: '<rect x="5" y="2" width="14" height="20" rx="2" ry="2"/><line x1="12" y1="18" x2="12.01" y2="18"/>'
  },
  'qrcode': {
    viewBox: '0 0 24 24',
    fill: 'none',
